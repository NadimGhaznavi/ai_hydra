...
class DLabel:
    ...
    NORMAL: Final[str] = "Normal"
    NUM_COOLDOWN_EPISODES: Final[str] = "# Cooldown Eps"
    ...
    ROUTER_ADDR: Final[str] = "Router Address"
    ROUTER_HB_PORT: Final[str] = "Router HB Port"
    ROUTER_PORT: Final[str] = "Router Port"
    ROUTER_STATUS: Final[str] = "Router Status"
    ...
    SERVER_ADDR: Final[str] = "Server Address"
    SERVER_PUB_PORT: Final[str] = "Server PUB Port"
    SERVER_STATUS: Final[str] = "Server Status"
    SNAPSHOT: Final[str] = "Snapshot"
    SPACE: Final[str] = " "
    START: Final[str] = "Start"
    STATUS: Final[str] = "Status"
