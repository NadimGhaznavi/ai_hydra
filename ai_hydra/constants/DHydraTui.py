...
class DField:
    ...
    MCTS_FREQUENCY_INPUT: Final[str] = "mcts_frequency_input"
    MCTS_FREQUENCY_LABEL: Final[str] = "mcts_frequency_label"
    MCTS_ITER_INPUT: Final[str] = "mcts_iter_input"
    MCTS_ITER_LABEL: Final[str] = "mcts_iter_label"
    MCTS_MEMORY: Final[str] = "mcts_memory"
    MCTS_REPLAY_MEM: Final[str] = "mcts_replay_mem"
...
class DLabel:
    ...
    MCTS_MEMORY: Final[str] = "Monte Carlo Memory"
