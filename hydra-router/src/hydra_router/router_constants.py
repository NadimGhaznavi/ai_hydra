"""
Hydra Router Constants

Constants for the Hydra Router system, providing standardized message formats
and configuration values for distributed communication.
"""
