"""
ai_snake_lab/server/SimHydra.py
...
class SimHydra:
    ...
    def __init__(self, router_addr=None):
        ...
        # ZeroMQ client for our app
        self.mq_client = MQClient(router=args.router)
    ...
    async def send_heartbeat(self):
        ...
        while not self.heartbeat_stop_event.is_set():
            ...
            await self.mq_client.send(mq_srv_msg(DMQ.HEARTBEAT, self.identity.decode()))
