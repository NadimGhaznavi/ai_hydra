...
At the core of *ATH Memory* is the concept of numbered *gears*.
...
If stagnation threshold episodes elapse without a new high score, the Train Manager sends a **stagnation alert** to the ATH Gearbox. The gearbox will shift down one gear, unless it has shifted up within the last stagnation threshold episodes.

If *critical stagnation threshold* episodes elapse without a new high score, the Train Manager sends a **critical stagnation alert** to the ATH Gearbox. The gearbox will shift directly to gear 1 (sequence length 4)
